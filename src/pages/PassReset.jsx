...
function PassReset() {
    ...
    const handleSubmit = async (evt) => {
        evt.preventDefault();
        await AuthsServices.reset(email).then(() => {
        ...
        <div className="background">
            ...
            <div className="frame position-abs">
                ...
                <div className="col-6">
                    ...
                    <div className="row-cols-6">
                        <InputText className="input1 text-white position-abs"
                            name="email"
                    ...
                    <div className="row-cols-6">
                        <Button className="button1 position-abs text-white text-enter1"onClick={handleSubmit} >
