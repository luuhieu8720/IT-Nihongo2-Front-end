...
function StudentSideBar() {
  ...
  return (
    <div className="" style={{ position: "fixed" }}>
      <div className="row">
        ...
        <div className="col-sm-auto" style={{ marginTop: "-3%" }}>
          <div className="dropdown">
            ...
            >
              <li>
                <Link className="dropdown-item" to="user/profile/setting">
                  Profile
                </Link>
              </li>
              <li>
      ...
      <h4 className="text-center" style={{ font: "Oxygen", marginTop: "10%" }}>
        Easy to find an experienced tutor for you!
      </h4>
      <Image
        src="Image/teacher-expectation.jpg"
        style={{ marginLeft: "-4%" }}
        alt="image"
        rounded
      ></Image>
      ...
      <Link to="post/add">
        <i
          ...
          className="bi bi-plus-circle fa-3x icon-purple"
        ></i>
      </Link>
    </div>
  );
