    ...
    return (
        <div className="">  
            ...
            <div className="" style={{ marginTop: '1.5%', display: 'inline-block' }}>
                <Image src={userInformation.avatar != "" ? userInformation.avatar : "/Image/avatardefault.png"} 
                alt="image" width="80" height="80" roundedCircle ></Image>
            ...
            <span className="position-abs text-name-profile">{userInformation.name}</span>
