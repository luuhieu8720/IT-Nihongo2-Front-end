        ...
        <div className="pt-3 ps-5">
            ...
            <Link className="position-abs" to="/user/profile/setting" onClick={handleProfileSubmit} >
                <i className="fst-normal bi bi-person fa-2x" 
                    id='id' style={{ display: 'inline-block', color: sessionStorage["stateTabIndex"] == "1" ? 'darkviolet' : 'rgba(0, 0, 0, 0.5)' }}
            ...
            <div className="mt-5">
                ...
                <i className="fst-normal bi bi-unlock fa-2x" tabIndex='1' id='id' style={{ display: 'inline-block', color: sessionStorage["stateTabIndex"] == "0" ? 'darkviolet' : 'rgba(0, 0, 0, 0.5)'  }}
