...
function SideBarProfile() {
    ...
    return (
        <div className="pt-3 ps-5">
            ...
            <Link className="position-abs" to="/user/profile/setting" onClick={handleProfileSubmit} ><i className="fst-normal bi bi-person fa-2x" tabIndex='1' id='id' style={{ display: 'inline-block' }}>
                <span className="ms-3" style={{ fontSize: '25px', fontFamily: 'Roboto' }}>Profile</span></i>
            </Link>
            <br />
            <div className="mt-5">
                <Link className="mt-4" to="/password/change"><i className="fst-normal bi bi-unlock fa-2x" tabIndex='1' id='id' style={{ display: 'inline-block' }}>
